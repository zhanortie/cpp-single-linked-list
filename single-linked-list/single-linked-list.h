...
public:
    ...
    Iterator InsertAfter(ConstIterator pos, const Type& value) {
        Node* subseq_node = new Node(value, pos.node_->next_node);
        pos.node_->next_node = subseq_node;
        ++size_;
        return Iterator(subseq_node);
    }
    ...
    Iterator EraseAfter(ConstIterator pos) noexcept {
        Node* subseq_node = pos.node_->next_node;
        Node* after_node = subseq_node->next_node;
        pos.node_->next_node = after_node;
        delete subseq_node;
        --size_;
